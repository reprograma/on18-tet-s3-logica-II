...
function carrinhodeCompras(cliente) {
    ...
    for (let item of cliente.carrinho) {
        ...
        valorTotalsemDesconto = valorTotalsemDesconto + item.valor;
        valorTotaldeDesconto = valorTotaldeDesconto + valordoDesconto;
...
console.log("***********************************")
carrinhodeCompras(clienteBulma)
console.log("***********************************")
carrinhodeCompras(clienteNesuko)