...
let clienteBrizza = {
  ...
  carrinho: [
    ...
    {produto: 'Tênis casual rosa', valor: 150.0}]
}
...
let clienteValdeci = {
  ...
  pagamento: 'à vista',
  carrinho: [
    {produto: 'Macacão florido', valor: 180.0},
    {produto: 'Pijama', valor: 50.0},
    {produto: 'Sandália dourada', valor: 70.0}]
}
...
function carrinhodeCompras(cliente) {
  ...
  if (cliente.carrinho.length > 10 || valorFinal > 800) {
      console.table('Parabéns! Você recebeu um cupom de R$ 50 para utilizar em sua próxima compra.');
  }
}
...
console.log("------------------------------------------------------------------------------------------")
carrinhodeCompras(clienteValdeci)
