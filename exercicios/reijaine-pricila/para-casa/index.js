...
let clienteLara = {
  ...
  carrinho: [
     ...
     {produto: 'Tenis nike', valor: 1800},
     {produto: 'Sandalia cocci', valor: 800.0}, 
     {produto: 'Fone', valor: 500.0}
...
carrinho: [
   ...
   {produto: 'biquini', valor: 80.0},
   {produto: 'canga', valor: 120.0}, 
   {produto: 'chapéu', valor: 50.0}
...
function carrinhodeCompras(cliente) {
  ...
  for (let item of cliente.carrinho) {
      if (item.valor >= 60 && item.valor < 100) {
          ...
          desconto = 'Você não recebeu desconto neste produto!'
      }
      ...
      console.log(`Produto: ${item.produto}. ${desconto} O valor final do produto é: ${valorposDesconto}. `);
