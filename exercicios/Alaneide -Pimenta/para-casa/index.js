...
console.log(`Compra realizada em: ${data} `);
   ...
   for (let item of cliente.carrinho) {
    if (item.valor >= 60 && item.valor < 100) {
        ...
        desconto = 'Você não ganhou desconto nesta peça!'
    }
    valorTotalsemDesconto = valorTotalsemDesconto + item.valor; // 1.506
    ...
    console.log(`Peça: ${item.produto}.Valor de desconto: R$ ${desconto} Valor final da peça:R$ ${valorposDesconto}`);
  ...
  console.log(`O valor total a pagar é de ${valorFinal}`);
...
console.log("O valor totl de desconto foi:" + valorTotaldeDesconto);
console.log("O valor final a após os descontos é de:" + valorFinalcomDesconto);
}
carrinhodeCompras(clienteLilit);
console.log("------------------------------")
carrinhodeCompras(clienteGabriela);
console.log("------------------------------")
carrinhodeCompras(clienteMonica);
  console.log("------------------------------")